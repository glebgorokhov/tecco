...
sr.reveal('.content__heading, .content__text, .company__quotetext, .company__quoteauthor, .content__scroll-link, .services__list, .services__quote, .case__smalltext, .content-tabs p, .case__logo, .case__subheading, .cases__text, .case__about__text, .case__about__list', fooReveal);
