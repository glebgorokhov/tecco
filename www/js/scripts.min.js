...
sr.reveal('.content__heading, .content__text, .company__quotetext, .company__quoteauthor, .content__scroll-link, .content__bgphone, .services__list, .services__quote, .case__smalltext, .content-tabs p, .case__logo, .case__subheading, .cases__heading, .cases__subheading, .cases__text, .case__about__text, .case__about__list', fooReveal);
sr.reveal('.content__scroll-link', fooReveal1);
