...
sr.reveal('.content__heading, .content__text, .company__quotetext, .company__quoteauthor, .content__scroll-link, .content__bgphone, .services__list, .services__quote, .case__smalltext, .content-tabs p, .case__logo, .case__subheading, .cases__heading, .cases__subheading, .cases__text', fooReveal);
sr.reveal('.company__abouttext, .company__features, .content__smalltext, .technology__name, .content__heading, .case__designblock p, .case__logo_bottom, .squareblock__social, .case__about__block, .case__about__lists, .case__about text', fooReveal1);
